...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderReport() {
        ...
        <b>Material CO2:</b> ${Number(data.materialCO2Val).toFixed(5)} kg CO2e
        <hr>
        ...
        <b>Package CO2 per PCS:</b> ${Number(data.packageCO2Val).toFixed(5)} kg CO2e
        <hr>
        <b>Process List:</b>
        ...
        <b>Total Process CO2:</b> ${Number(data.processCO2Val).toFixed(5)} kg CO2e
        <hr>
        <b style="font-size:1.1em;">Total CO2:</b> <span style="font-size:1.2em;">${Number(data.totalCO2).toFixed(5)} kg CO2e</span>
        `;
    }
